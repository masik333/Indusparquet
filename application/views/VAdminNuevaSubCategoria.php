...
<body>
  ...
  <div class="main-panel">
    ...
    <form action="<?php echo base_url(); ?>CAdminNuevaSubCategoria/registrarSubCategoria/?id=<?php echo $id; ?>" id="formulario-subcategoria" class="col s5">
            <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> Nueva Sub-Categoria</h4>
                  <p class="card-category"> Agregar nueva Sub-Categoria al sistema.</p>
                </div>
          ...
          <div class="card-body">
            ...
            <div class="col-6 btn-sen text-right">
            <input type="submit" value="Agregar Sub Categoria" class="btn btn-success"/>
            </div>
      </div>
</div>
</form>
    ...
    <script src="https://code.jquery.com/jquery-3.3.1.min.js" integrity="sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8=" crossorigin="anonymous"></script>
      ...
      <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/funciones/subcategorias.js"></script>
