...
<body>
  ...
  <div class="main-panel">
    ...
    <form action="<?php echo base_url(); ?>CAdminNuevaCategoria/registrarCategoria" method="post" class="col s5" enctype="multipart/form-data" id="formulario">
            <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> Nueva Categoria</h4>
                  <p class="card-category"> Agregar una nueva categoria al sistema.</p>
                </div>
