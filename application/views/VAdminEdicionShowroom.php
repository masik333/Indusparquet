...
<body>
  ...
  <div class="main-panel">
      ...
      <div class="content">
         <div class="container">
    <form action="<?php echo base_url(); ?>CAdminEdicionShowroom/modificarShowroom/<?php echo $resultado->id; ?>" id="edicion-formulario" method="post" class="col s5" enctype="multipart/form-data">
                       <a href="<?php echo base_url(); ?>CAdminListadoShowrooms" class="btn btn-warning">Volver</a>
                        <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> Editar Showroom</h4>
                  <p class="card-category"> Modificar datos del Showroom.</p>
                </div>
          ...
          <div class="col-6">  
            <label>Dirección</label>
             <input type="text" name="direccion" class="form-control" value="<?php echo $resultado->direccion; ?>" id="pac-input"/>
          </div>  
        </div>
        <div class="row">
          <div class="col-6">  
            <label>Teléfono</label>
             <input type="text" name="telefono" class="form-control" value="<?php echo $resultado->telefono; ?>"/>
            </div>  
          <div class="col-6">  
            <label>Email</label>
           ...
           <iframe
              ...
              frameborder="0" 
              style="border:0"
              src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAnl9yOiczwQ_VndACe0Dt3wtrzEQvbVu8
              &q=<?php echo $resultado->direccion; ?>" allowfullscreen>
           </iframe>
           <!--<input type="text" name="mapa" class="form-control" value="<?php echo $resultado->direccion; ?>"/> --> 
