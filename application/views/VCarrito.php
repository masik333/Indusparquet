 <!DOCTYPE html>
  <html>
    <head>
    	<meta charset="utf-8">
      <title>MI CARRITO | INDUSPARQUET</title>
  ...
  <ul class="sidenav" id="mobile-demo">
    ...
    <li><a href="mobile.html">Red de Distribuidores</a></li>
            ...
            <nav>
              <div class="container">
                <div class="col s12">
                  ...
                  <a href="#!" class="breadcrumb">MI CARRITO</a>
                </div>
              </div>
            </nav>
          </div>
      <!-- Secciones -->
       <div class="container carrito">
        ...
        <tbody>
          ...
          <tr>
            <td><img src="<?php echo base_url(); ?>assets/img/productos/<?php echo $row->imagenPrincipal; ?>"></td>
            <td><?php echo $row->nombre; ?><br><span style="color: black"><?php echo $row->categoria; ?></span></td>
            <td>$<span style="color: black"><?php echo $row->precioFijo; ?></span></td>
            <td><span style="color: black"><?php echo $row->cantidadMetros; ?> Mts²</span></td>
            <td class="precioProducto">$<span style="color: black" class="precio"><?php echo $row->cantidadMetros * $row->precioFijo ?></span></td>
            <td><a href="<?php echo base_url(); ?>CCarrito/eliminarCompra/?id=<?php echo $row->prod; ?>" class="delete-product"><i class="tiny material-icons">close</i></a></td>
          </tr>
          <?php } ?>
          <tr>
            <td></td>
      ...
      <div class="right-align">
          ...
          <a href="#" class="btn-green">TERMINAR COMPRA</a>
