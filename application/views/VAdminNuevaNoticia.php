...
<body>
  ...
  <div class="main-panel">
      ...
      <div class="content">
         <div class="row">
    <form action="<?php echo base_url(); ?>CAdminNuevaNoticia/registrarNoticia" method="post" class="col s5" enctype="multipart/form-data" id="formulario">
            <a href="<?php echo base_url(); ?>CAdminListadoNoticias" class="btn btn-warning">Volver</a>
            <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> Nueva Noticia</h4>
                  <p class="card-category"> Agregar nueva Noticia o Novedad. Complete todos los campos.</p>
                </div>
          ...
          <label>Título</label>     
            ...
            <input id="01" type="file" name="imagen" accept="image/*">
</div>
