...
<body>
  ...
  <div class="main-panel">
      ...
      <div class="content">
         <div class="container">
<div class="row">
<form action="<?php echo base_url(); ?>CAdminNuevoUsuario/registrarUsuario" method="post" id="formulario" class="col s5">
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Agregar nuevo usuario al sistema. Complete todos los campos.</p>
                </div>
