...
<body>
  ...
  <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <form method="GET" action="<?php echo base_url(); ?>CAdminListadoShowrooms/filtrarShowrooms" class="navbar-form">
      ...
      <div class="content">
          <div class="">
        <a href="<?php echo base_url(); ?>CAdminNuevoShowroom" class="btn btn-info">Nuevo Showroom</a>
        </div>
<div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> Listado de Showrooms</h4>
                  <p class="card-category"> Listado general de todos los Showrooms.</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            <th class="mdl-data-table__cell--non-numeric">Showroom</th>
                        ...
                        <td class="td-actions text-right">
                                  ...
                                  <a href="<?php echo base_url(); ?>CAdminEdicionShowroom/?id=<?php echo $row->id; ?>"><i class="material-icons">edit</i></a>
                                  </button>
                        ...
                        <div id="modal<?php echo $row->id; ?>" class="modal">
                            <div class="modal-content">
                                <h4>¿Eliminar Showroom <?php echo $row->nombre; ?>?</h4>                                  
                            </div>
                            <div class="modal-footer">
                              <a href="#!" class="modal-close btn btn-succes">Cancelar</a>
                                <a href="<?php echo base_url(); ?>CAdminListadoShowrooms/eliminarShowroom/?id=<?php echo $row->id; ?>" id="<?php echo $row->id; ?>" class="modal-close btn btn-danger delete">Eliminar</a>
                            </div>
                        </div>
                      <?php } 
                      } else {
                            foreach ($resultadoShowrooms as $rowShowroom) { ?>
                            <tr>
                        <td class="mdl-data-table__cell--non-numeric"><?php echo $rowShowroom->nombre; ?></td>
                        <td class="text-center"><?php echo $rowShowroom->direccion; ?></td>                        
                        <td class="td-actions text-right">
                                  <button type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                  <a href="<?php echo base_url(); ?>CAdminEdicionShowroom/?id=<?php echo $rowShowroom->id; ?>"><i class="material-icons">edit</i></a>
                                  </button>
                                  <button type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm">
                                   <a href="#modal<?php echo $rowShowroom->id; ?>" class="modal-trigger"><i class="material-icons">close</i></a>
                                  </button>
                        </td>
                        </tr>
                            ...
                            <!-- Modal Structure -->
                        <div id="modal<?php echo $rowShowroom->id; ?>" class="modal">
                            <div class="modal-content">
                                <h4>¿Eliminar Showroom <?php echo $rowShowroom->nombre; ?>?</h4>                                  
                            </div>
                            <div class="modal-footer">
                              <a href="#!" class="modal-close btn btn-succes">Cancelar</a>
                                <a href="<?php echo base_url(); ?>CAdminListadoShowrooms/eliminarShowroom/?id=<?php echo $rowShowroom->id; ?>" id="<?php echo $rowShowroom->id; ?>" class="modal-close btn btn-danger delete">Eliminar</a>
                            </div>
                        </div>
                        <?php }
                        } ?>
