      ...
      <!-- Secciones -->
          ...
          <div class="container card-estatica ">
            <div class="card">
             ...
             <form class="col m12" method="POST" action="<?php echo base_url(); ?>CRegistroUsuario/registrarUsuario" id="formulario">
                        ...
                        <div class="right-align">
                         <button type="submit" class="btn-green">REGISTRARME</button>
                      </div>  
                    </form>     
                  </div>    
            </div>  
